# TODO: capture raw speed based on number of MS2 spectra
# 
# Author: cshughes
###############################################################################
setwd(dir="/Users/cshughes/Documents/projects/tmtPlexing/ratePaper_rawSpeed/Routput/")
#grab the PSM files from Proteome Discoverer
infiles = dir("/Users/cshughes/Documents/projects/tmtPlexing/ratePaper_rawSpeed", pattern="PSMs\\.txt", full.names=TRUE)
...
infiles = dir("/Users/cshughes/Documents/projects/tmtPlexing/ratePaper_rawSpeed", pattern="Proteins\\.txt", full.names=TRUE)
#read in the files into a list
...
infiles = dir("/Users/cshughes/Documents/projects/tmtPlexing/ratePaper_rawSpeed", pattern="MSMSSpectrumInfo\\.txt", full.names=TRUE)
#read in the files into a list
...
infiles = dir("/Users/cshughes/Documents/projects/tmtPlexing/ratePaper_rawSpeed", pattern="QuanSpectra\\.txt", full.names=TRUE)
#read in the files into a list
