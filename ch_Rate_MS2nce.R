...
# Author: cshughes
###############################################################################
setwd(dir="/Users/cshughes/Documents/projects/tmtPlexing/ratePaper_MS2nce/Routput/")
#grab the MS2 files from Proteome Discoverer
infiles = dir("/Users/cshughes/Documents/projects/tmtPlexing/ratePaper_MS2nce", pattern="PSMs\\.txt", full.names=TRUE)
